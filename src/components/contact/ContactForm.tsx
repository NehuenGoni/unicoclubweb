          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-5">
              <a
                ...
                className="w-14 h-14 rounded-full border border-[var(--border)] bg-[var(--bg-card)] flex items-center justify-center text-[#25D366] hover:border-[#25D366]/60 hover:bg-[#25D366]/10 hover:-translate-y-0.5 transition-all"
              >
              ...
              <a
                ...
                className="w-14 h-14 rounded-full border border-[var(--border)] bg-[var(--bg-card)] flex items-center justify-center text-[#E1306C] hover:border-[#E1306C]/60 hover:bg-[#E1306C]/10 hover:-translate-y-0.5 transition-all"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
