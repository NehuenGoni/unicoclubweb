...
export default function PlaytomicSection() {
  return (
    <div className="min-h-screen pt-16 bg-[var(--bg-base)]">
            ...
            {USE_WIDGET ? (
              ...
              <div className="flex flex-col items-center gap-3 mt-2">
                <a
                  ...
                  className="group inline-flex items-center gap-3 px-8 py-4 rounded-md bg-[var(--accent)] hover:bg-[var(--accent-light)] text-white font-semibold text-base transition-all shadow-lg shadow-[var(--accent)]/30 hover:shadow-[var(--accent)]/50 hover:-translate-y-0.5"
                >
      ...
      {/* ── WhatsApp Booking ────────────────────────────────── */}
      <section className="py-8 px-4 sm:px-6 bg-[var(--bg-card)]">
        <div className="max-w-3xl mx-auto flex items-center gap-3">
          <a
            href={SOCIALS.whatsappReservations.url}
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-2 px-6 py-3 rounded-md bg-[var(--accent)] hover:bg-[var(--accent-light)] text-white font-semibold text-sm transition-all shadow-lg shadow-[var(--accent)]/30 hover:shadow-[var(--accent)]/50"
          >
          ...
          <p className="text-[var(--text-secondary)] text-sm">Quick and easy reservations</p>
        </div>
      </section>
